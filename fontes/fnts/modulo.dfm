object frmmodulo: Tfrmmodulo
  ...
  object qrvenda: TZQuery
    ...
    object qrvendaCODFILIAL: TWideStringField
      FieldName = 'CODFILIAL'
      Size = 10
    end
    object qrvendaCODLOCAL: TWideStringField
      FieldName = 'CODLOCAL'
      Size = 10
    end
    object qrvendaCOR: TWideStringField
      FieldName = 'COR'
      Size = 15
    end
    object qrvendaTAMANHO: TWideStringField
      FieldName = 'TAMANHO'
      Size = 15
    end
  end
